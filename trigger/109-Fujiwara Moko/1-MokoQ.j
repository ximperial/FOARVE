//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_MokoQ_Func001 takes nothing returns nothing
  ...
  if count == 1 then
    call SoundStart("war3mapImported\\Moko_1.mp3")
  ...
  if count <= 15 then
    ...
    loop
      ...
      if FilterGeneral(c, gUnit) and not IsUnitInGroup(gUnit, g) then
        call DamageUnit(c, gUnit, 100 * GetUnitAbilityLevel(c, 'A0HU'))
...
function Trig_MokoQ_Actions takes nothing returns nothing
  local timer z
  local unit c = GetTriggerUnit()
  local real a = Angle(GetUnitX(c) , GetUnitY(c) , GetSpellTargetX() , GetSpellTargetY())
  if GetSpellAbilityId() == 'A0HU' then
    set z = CreateTimer()
    call PauseUnit(c, true)
    ...
    call TimerStart(z, 0.02, true, function Trig_MokoQ_Func001)
  endif
  set z = null
  set c = null
endfunction
...
//===========================================================================
function InitTrig_MokoQ takes nothing returns nothing
  set gg_trg_MokoQ = CreateTrigger()
  call TriggerRegisterAnyUnitEventBJ(gg_trg_MokoQ, EVENT_PLAYER_UNIT_SPELL_EFFECT)
  call TriggerAddAction(gg_trg_MokoQ, function Trig_MokoQ_Actions)
endfunction