scope acespell initializer init
        ...
        if count <= 15 then
            ...
            loop
                ...
                if FilterGeneral(u, gUnit) and not IsUnitInGroup(gUnit, g) then
                    call DamageUnit(u, gUnit, GetHeroStr(u, true) + 90 * GetUnitAbilityLevel(u, 'A0AA'))
        ...
        if count >= 40 and count <= 140 then
            ...
            if iterator >= 5 then
                ...
                loop
                    ...
                    exitwhen gUnit == null
                    if FilterGeneral(u, gUnit) then
                        call DamageUnit(u, gUnit, ((1 + GetUnitAbilityLevel(u, 'A0AC')) * GetHeroStr(u, true)) / 20)
                    endif
                endloop
                call GroupClear(gGroup)
            endif
    ...
    private function period4 takes nothing returns nothing
        ...
        if count >= 30 and count <= 70 then
            ...
            call SetSpecialEffectHeight(e, 250)
        endif
        if count == 70 then
    ...
    private function period5 takes nothing returns nothing
        ...
        if count >= 80 and count <= 200 then
            ...
            call SetSpecialEffectHeight(e, GetEffectHeight(e) + 3)
    ...
    private function period7 takes nothing returns nothing
        ...
        if count == 140 then
            ...
            loop
                ...
                set x = GetEffectX(e)
                set y = GetEffectY(e)
                call Effect("war3mapImported\\[A]BY_Wood_XianHuo_2.mdl", x, y, GetEffectHeight(e) , randomAngle() , 0, 0, 1.5, 1.5, 255, 255, 255, 255)
                call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.8)
