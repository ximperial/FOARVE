scope cloudspell initializer init
        ...
        if count <= 15 then
            ...
            loop
                ...
                if FilterGeneral(u, gUnit) and not IsUnitInGroup(gUnit, g) then
                    call DamageUnit(u, gUnit, GetHeroStr(u, true) + 90 * GetUnitAbilityLevel(u, 'A0IC'))
            ...
            if iterator >= 3 then
                ...
                call Effect("war3mapImported\\BY_Wood_Eff_Ord_YeYe_Wid_KuoSan_3.mdx", GetUnitX(u) , GetUnitY(u) , 0, randomAngle() , 0, 0, 1.2, 1, 255, 255, 255, 255)
            endif
        endif
        if count == 15 then
    ...
    private function period2 takes nothing returns nothing
        ...
        if count == 20 then
            ...
            call Effect("war3mapImported\\daoguang.mdx", GetUnitX(u) , GetUnitY(u) , 0, a, 0, 0, 2, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.75)
        endif
        if count == 25 then 
            ...
            call Effect("war3mapImported\\Dead Spirit by Deckai2.mdx", GetUnitX(t) , GetUnitY(t) , 0, randomAngle() , 0, 0, 2.5, 1.5, 255, 255, 255, 255)
            ...
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.75)
            call Effect("war3mapImported\\[A]ZoroEf6.mdx", GetUnitX(t) , GetUnitY(t) , 0, randomAngle() , 0, 0, 1, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.5)
            call Effect("war3mapImported\\[A]slashdigital.mdx", GetUnitX(t) , GetUnitY(t) , 50, a + 40, 0, 0, 2, 1, 255, 255, 255, 255)
    ...
    private function period3 takes nothing returns nothing
        ...
        if count == 1 then
            ...
            call Effect("war3mapImported\\ChargeBlue1.mdx", GetUnitX(u) , GetUnitY(u) , 100, randomAngle() , 0, 0, 2, 1, 255, 255, 255, 255)
    ...
    private function period4 takes nothing returns nothing
        ...
        if count == 10 or count == 25 or count == 40 or count == 55 or count == 70 or count == 85 then
            ...
            call Effect("war3mapImported\\daoguang-blue-hengsao.mdx", x, y, 100, a, 0, 0, 0.75, 1, 255, 255, 255, 255)
        ...
        if count == 130 then 
            ...
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.8)
            call Effect("war3mapImported\\by_wood_effect_yuanbanlin_sand2.mdx", GetUnitX(t) , GetUnitY(t) , 0, randomAngle() , 0, 0, 1.5, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.75)
            set i = 0
            loop
                exitwhen i > 8
    ...
    private function period5 takes nothing returns nothing
        ...
        if count == 1 then
            ...
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.75)
            call Effect("war3mapImported\\ChargeBlue1.mdx", GetUnitX(u) , GetUnitY(u) , 100, randomAngle() , 0, 0, 2, 1.5, 255, 255, 255, 255)
        endif
        if count == 50 then
            set x = PolarX(GetUnitX(t) , - 120, a)
            set y = PolarY(GetUnitY(t) , - 120, a)
        ...
        if count >= 50 and count <= 120 then
            ...
            if iterator >= 5 then
                call SaveInteger(ht, zid, 1, 0)
                call Effect("war3mapImported\\HakenSaber2.mdx", GetUnitX(u) , GetUnitY(u) , 520, randomAngle() , 0, 0, GetRandomReal(0.75, 1.25) , 1, 220, 255, 255, PercentTo255(80))
                call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.8)
                call Effect("war3mapImported\\DustWaveAnimate2.mdx", GetUnitX(u) , GetUnitY(u) , 510, randomAngle() , 0, 0, GetRandomReal(0.75, 1.25) , 1, 220, 255, 255, PercentTo255(60))
                call SetSpecialEffectAnimation(bj_lastCreatedEffect, "stand")
                call Effect("war3mapImported\\DustWaveAnimate2.mdx", GetUnitX(u) , GetUnitY(u) , 510, randomAngle() , 0, 0, GetRandomReal(0.85, 1.35) , 1, 220, 255, 255, PercentTo255(80))
                call SetSpecialEffectAnimation(bj_lastCreatedEffect, "stand")
            endif
        endif
        if count == 100 then
        ...
        if count >= 110 and count <= 380 then 
            ...
            if iterator >= 5 then
                call SaveInteger(ht, zid, 1, 0)
                set a2 = randomAngle()
                set x = PolarX(GetUnitX(t) , GetRandomReal(100, 350) , a2)
                set y = PolarY(GetUnitY(t) , GetRandomReal(100, 350) , a2)
                set pitch = GetRandomReal(- 45, - 30)
                call Effect("war3mapImported\\zhanji-blueX-shu2.mdx", x, y, GetRandomReal(550, 650) , a2 , pitch , 0, GetRandomReal(3, 4) , 1, 255, 255, 255, 255)
                call Effect("war3mapImported\\DT112.mdx", x, y, GetRandomReal(450, 550) , a2 , pitch , 0, GetRandomReal(1.5, 2) , 1, 255, 255, 255, 255)
                call Effect("war3mapImported\\uissb.mdx", x, y, GetRandomReal(500, 550) , a2 , pitch , 0, GetRandomReal(3, 4) , 1, 255, 255, 255, 255)
            endif
            ...
            if iterator2 >= 10 then
                ...
                set a2 = randomAngle()
                set x = PolarX(GetUnitX(t) , GetRandomReal(150, 350) , a2)
                set y = PolarY(GetUnitY(t) , GetRandomReal(150, 350) , a2)
                call SetUnitXY(u, x, y, 0)
        ...
        if count == 400 then
            call Effect("war3mapImported\\AFB_SatomiRentaro_KuDing.mdx", GetUnitX(t) , GetUnitY(t) , 500, randomAngle() , 0, 0, 2, 1.5, 255, 255, 255, 255)
        ...
        if count == 410 then 
            ...
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.5)
            call Effect("war3mapImported\\dls1.mdx", GetUnitX(t) , GetUnitY(t) , 0, randomAngle() , 0, 0, 1, 2, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.75)
        endif
        if count == 420 then 
            call SetUnitTimeScale(u, 1)
    ...
    private function period6 takes nothing returns nothing
        ...
        if count == 20 then
            ...
            call UnitAddAbility(t, 'Amrf')
            call UnitRemoveAbility(t, 'Amrf')
            call Effect("war3mapImported\\blueslash.mdx", GetUnitX(u) , GetUnitY(u) , 100, a, 0, 0, 5, 1, 255, 255, 255, 255)
        ...
        if count == 55 then
            call Effect("war3mapImported\\AFB_SatomiRentaro_KuDing.mdx", GetUnitX(t) , GetUnitY(t) , 600, a, - 315, 0, 1.5, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectAnimationByIndex(bj_lastCreatedEffect, 0)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.8)
            call Effect("war3mapImported\\DT112.mdx", GetUnitX(t) , GetUnitY(t) , 600, a, - 315, 0, 1.25, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.6)
        endif
        if count == 60 then 
            ...
            call ShakeCamera(1, GetOwningPlayer(u) , 15)
            call ShakeCamera(1, GetOwningPlayer(t) , 15)
            call Effect("war3mapImported\\Dls1.mdx", GetUnitX(t) , GetUnitY(t) , 0, randomAngle() , 0, 0, 1.5, 1.5, 255, 255, 255, 255)
            call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.8)
