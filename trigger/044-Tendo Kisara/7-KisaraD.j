//TESH.scrollpos=32
//TESH.alwaysfold=0
function Trig_KisaraD_Func001 takes nothing returns nothing
...
function Trig_KisaraD_Actions takes nothing returns nothing
    local timer z
    ...
    if GetSpellAbilityId() == 'A01X' then 
        ...
        call TimerStart(z, 0.02, true, function Trig_KisaraD_Func001)
    endif
    set z = null
    set c = null
    set t = null
...
//===========================================================================
function InitTrig_KisaraD takes nothing returns nothing
    set gg_trg_KisaraD = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ(gg_trg_KisaraD, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddAction( gg_trg_KisaraD, function Trig_KisaraD_Actions )
endfunction