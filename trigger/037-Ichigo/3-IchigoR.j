//TESH.scrollpos=39
//TESH.alwaysfold=0
function Trig_IchigoR_Func001 takes nothing returns nothing
    ...
    if count == 1 then
        ...
        call Effect("war3mapImported\\az_red-xuanwo.mdx", GetUnitX(c), GetUnitY(c), 25, a, 0, 0, 1.5, 1, 255, 255, 255, PercentTo255(90))
        call Effect("war3mapImported\\bymutou-hongse3.mdx", GetUnitX(c), GetUnitY(c), 25, a, 0, 0, 1.25, 1, 255, 255, 255, PercentTo255(20))
    ...
    if count == 165 then 
        ...
        call DamageUnit(c, t, (6 + 2 * GetUnitAbilityLevel(c, 'A0DV')) * GetHeroStr(c, true))
...
function Trig_IchigoR_Actions takes nothing returns nothing
    local timer z
    ...
    if GetSpellAbilityId() == 'A0DV' then 
        ...
        call SaveInteger(ht, GetHandleId(z), 1, 0)
        call TimerStart(z, 0.02, true, function Trig_IchigoR_Func001)
    endif
    set z = null
    set c = null
    set t = null
...
//===========================================================================
function InitTrig_IchigoR takes nothing returns nothing
    set gg_trg_IchigoR = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ(gg_trg_IchigoR, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddAction( gg_trg_IchigoR, function Trig_IchigoR_Actions )
endfunction