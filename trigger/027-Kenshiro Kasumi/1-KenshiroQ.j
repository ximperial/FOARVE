//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_KenshiroQ_Func001 takes nothing returns nothing
    ...
    if count <= 15 then
        ...
        loop
            ...
            if FilterGeneral(c, gUnit) and not IsUnitInGroup(gUnit, g) then
                ...
                call SetSpecialEffectTimeScale(bj_lastCreatedEffect, 0.5)
                call DamageUnit(c, gUnit, 100 * GetUnitAbilityLevel(c, 'A065'))
...
function Trig_KenshiroQ_Actions takes nothing returns nothing
    local timer z
    ...
    if GetSpellAbilityId() == 'A065' then
        ...
        call TimerStart(z, 0.02, true, function Trig_KenshiroQ_Func001)
    endif
    set z = null
    set c = null
endfunction
...
//===========================================================================
function InitTrig_KenshiroQ takes nothing returns nothing
    set gg_trg_KenshiroQ = CreateTrigger(  )
    call TriggerRegisterAnyUnitEventBJ(gg_trg_KenshiroQ, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddAction( gg_trg_KenshiroQ, function Trig_KenshiroQ_Actions )
endfunction