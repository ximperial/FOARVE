//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_ToshiF_Func001 takes nothing returns nothing
...
function Trig_ToshiF_Actions takes nothing returns nothing
    local timer z
    ...
    if GetSpellAbilityId() == 'A0CC' then 
        ...
        call TimerStart(z, 0.02, true, function Trig_ToshiF_Func001)
    endif
    set z = null
    set c = null
    set t = null
...
//===========================================================================
function InitTrig_ToshiF takes nothing returns nothing
    set gg_trg_ToshiF = CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_ToshiF, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddAction(gg_trg_ToshiF, function Trig_ToshiF_Actions)
endfunction